...
if __name__=="__main__":
    ...
    if all(key in settings for key in key_list):
        ...
        if("pincode" in settings.keys()):
            ...
            if(state!="" and dist!=""):
                ...
                if(st_id!=""):
                    ...
                    print("--------------")
                    print(sys.argv[1])
                    print(datetime.datetime.now(tz).strftime("%A %d-%B-%Y %-I:%M:%S %p"))
        ...
        if(flag):
            ...
            if available:
                msg_body = "Slots Available at {total} places.\n{available}\n{settingsfile}".format(total = total_centers,available = available, settingsfile = sys.argv[1])
                print(msg_body)
        ...
        print("Arguments Missing/Invalid. Check", sys.argv[1])
